...
export default async function handler(req, res) {
  try {
    ...
    // ✅ Response data structure - OTHER_TYPES INCLUDED
    const resultData = {
      number_info: [],
      ration: [],
      aadhar: [],
      other_types: [] // 👈 YAHI SE DATA DIKHEGA
    };
    ...
    // 🔥 STEP 1: AGAR KOI SPECIFIC TYPE DIYA HAI
    if (type) {
      if (type === 'mobile') {
        ...
        // 🔥 OTHER TYPES - YAHAN DATA AAEGA AUR RESPONSE MEIN DIKHEGA
    ...
    if (term && !type && !number && !aadhaarInput) {
      ...
      if (detectedType === 'mobile') {
        ...
        // Other type - auto-detect se bhi data dikhega
